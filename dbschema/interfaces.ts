...
export namespace coreforce {
  export type IssueType = "Description" | "Title" | "Image" | "StateRestriction" | "Other";
  export interface ProductIssue extends std.$Object {
    "email"?: string | null;
    "extra"?: string | null;
    "issueType": IssueType;
    "productId": number;
...
export type ModuleName = $default.ModuleName;
...
export interface types {
  ...
  "coreforce": {
    "IssueType": coreforce.IssueType;
    "ProductIssue": coreforce.ProductIssue;
  };
  "default": {
